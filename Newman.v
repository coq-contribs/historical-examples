...
(* Though this file shows a specific example of what can be written in
   the pure Calculus of Constructions subset of Coq, it has still been
   part of the standard library until Coq V8.0.

   The first known version of this development goes back to CoC
   V1.10. Until CoC V4.3, it was called Newman.ml (there were no
   stand-alone parser before V4.3). Until V4.4, Newman.v included the
   file Rstar.v. From V4.4 to V5.9, the file Rstar.v was called
   Relations.v.
*)
