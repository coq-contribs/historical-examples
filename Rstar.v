...
(* This file is a prerequisite for Tarski.v. Its contents can be
   retrieved in CoC version 1.10. At this time it was part of the file
   Tarski.v (which itself was called Tarski.ml). Rstar.v has been
   separated from Tarski.v in CoC V4.5. At this time it was called
   Relations.v, a name that changed to Rstar.v in Coq V5.10.
*)
(************************************************************************)
